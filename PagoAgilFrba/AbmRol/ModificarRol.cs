...
namespace PagoAgilFrba.AbmRol
{
    public partial class ModificarRol : Form
    {
        ...
        private bool estaHabilitado()
        {
            ...
            String consulta = "SELECT COUNT(DISTINCT rol_nombre) FROM AMBDA.Rol WHERE rol_nombre = @rol and rol_habilitado = 1";
        ...
        private void MarcarLasFuncionalidadesQueTiene()
        {
            ...
            foreach (DataRowView funcionalidad in this.checkedListBoxFuncionalidades.Items)
            {
                ...
                if (verificarSiLaTiene(funcionalidad.Row["func_descripcion"] as String))
                {
        ...
        private void RenombrarRol()
        {
            ...
            String sql = "UPDATE AMBDA.Rol SET rol_nombre = @nombre_nuevo WHERE rol_nombre = @nombre_viejo";
        ...
        private void AgregarFuncionalidades()
        {
            ...
            foreach (DataRowView funcionalidad in this.checkedListBoxFuncionalidades.CheckedItems)
            {
                ...
                else
                {
                    ...
                    String sql1 = "INSERT INTO AMBDA.RolxFunc(func_id, rol_id) VALUES ((SELECT func_id FROM AMBDA.Funcionalidad WHERE func_descripcion = @funcionalidad), (SELECT rol_id FROM AMBDA.Rol WHERE rol_nombre = @rol))";
        ...
        private bool verificarSiLaTiene(String funcionalidad)
        {
            ...
            String consulta = "SELECT COUNT(*) FROM AMBDA.RolxFunc WHERE func_id = (SELECT func_id FROM AMBDA.Funcionalidad WHERE func_descripcion = @funcionalidad) and rol_id = (SELECT rol_id FROM AMBDA.Rol WHERE rol_nombre = @rol)";
        ...
        private void QuitarFuncionalidades()
        {
            ...
            foreach (DataRowView funcionalidad in this.checkedListBoxFuncionalidades.Items)
            {
                ...
                if (estado == "Unchecked")
                {
                    ...
                    String sql2 = "DELETE AMBDA.RolxFunc WHERE func_id = (SELECT func_id FROM AMBDA.Funcionalidad WHERE func_descripcion = @funcionalidad) and rol_id = (SELECT rol_id FROM AMBDA.Rol WHERE rol_nombre = @rol)";
        ...
        private void HabilitarRol()
        {
            ...
            String sql = "UPDATE AMBDA.Rol SET rol_habilitado = 1 WHERE rol_nombre = @nombre";
